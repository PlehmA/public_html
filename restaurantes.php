...
<div class="container">
  ...
  <?php
    ...
    $sql = "SELECT * FROM restaurantes LIMIT $start, $per_page";
  ...
  ?>
  <h1 class="jumbotron text-center animated fadeInLeft">Restaurantes   <i class="fa fa-glass" aria-hidden="true" style="color: #FFE760;"></i></h1>
  ...
  <div>
    ...
    echo "<ul class='pager'>";
    echo "<li><a href='restaurantes.php?page=1'>".'Primera'."</a></li>";
    echo "<li><a href='restaurantes.php?page=$total_pages'>".'Ultima'."</a></li>";
    echo "</ul>";
    echo "<nav aria-label='Page navigation' id='div1'>";
    echo "<ul class='pager'>";

    for ($i = 1; $i<=$total_pages; $i++) {
      echo "<li><a href='restaurantes.php?page=".$i."'>".$i."</a></li>";
    }

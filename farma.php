...
<div class="container">
  ...
  <thead>
    <tr class="animated rotateInDownRight">
      <th>Nombre <i class="fa fa-users pull-right animated flipInY" aria-hidden="true"></i></th>
      <th>Dirección <i class="fa fa-map-marker pull-right animated flipInY" aria-hidden="true"></i></th>
      <th>Teléfono <i class="fa fa-phone pull-right animated flipInY" aria-hidden="true"></i></th>
      <th>Imagen <i class="fa fa-camera pull-right animated flipInY" aria-hidden="true"></i></th>
      <th>¿Donde se encuentra? <i class="fa fa-street-view pull-right animated flipInY" aria-hidden="true"></i></th>
    </tr>
  </thead>
  <tbody>

...
<body>
<div class="container">
	<form class="form-horizontal" action="indumentariadd.php" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
<fieldset>

<!-- Form Name -->
<legend>Formulario Indumentaria</legend>
<br>
<!-- Text input-->
